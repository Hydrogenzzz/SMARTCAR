...
//    menu_add_item("MAIN","speed",&speed,TYPE_FLOAT,TRUE);
    menu_add_item("MAIN","speedleft",&speedleft,TYPE_FLOAT,TRUE);
    menu_add_item("MAIN","speedright",&speedright,TYPE_FLOAT,TRUE);
